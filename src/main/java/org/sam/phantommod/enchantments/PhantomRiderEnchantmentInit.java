...
public class PhantomRiderEnchantmentInit {

    public static final Identifier IDENTIFIER = Identifier.of(Phantommod.MOD_ID, "phantom_rider");

    public static final RegistryKey<Enchantment> PHANTOM_RIDER_KEY = RegistryKey.of(RegistryKeys.ENCHANTMENT, IDENTIFIER);

    public static final MapCodec<PhantomRiderEnchantmentEffect> PHANTOM_RIDER_EFFECT = register("phantom_rider", PhantomRiderEnchantmentEffect.CODEC);
